class Bigbluebutton::RecordingsController < ApplicationController
  ...
  def update
    respond_with @recording do |format|
      if @recording.update_attributes(bigbluebutton_recording_params)
        format.html {
  ...
  def bigbluebutton_recording_params
    params.require(:bigbluebutton_recording),permit(:recordid, :meetingid, :name, :published, :start_time,
